...
import serviceData from "../../../data/allwasteData.json";

export const metadata: Metadata = {
  title: "Comprehensive Waste Management Solutions | Oil Recycling & Waste Removal",
  description: "Professional waste management services including industrial recycling, MEP waste handling, oil recycling, and eco-friendly waste removal. ISO-certified sustainable solutions.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Environmentally responsible waste management services including recycling, disposal, and waste-to-energy solutions",
    images: [{
...
async function getServiceData() {
  // In real implementation you might fetch from API
