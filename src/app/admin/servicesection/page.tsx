      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold tracking-tight gradient-text">Services Section</h1>
            <div className="ml-2 bg-background px-3 py-1 rounded-full text-xs !border-[0.5px] !border-white/10 text-muted-foreground">
              Homepage
            </div>
          </div>
          <p className="text-muted-foreground">Customize the services section that appears on your homepage.</p>
        </div>
        <div className="flex items-center gap-2">
