...
import serviceData from "../../../data/language.json";

export const metadata: Metadata = {
  title: "Foreign Language Courses & Certification Programs | Professional Language Training",
  description: "Comprehensive language learning programs with certified instructors. Learn English, Arabic, French, and more with our immersive teaching methodology.",
  keywords: [
